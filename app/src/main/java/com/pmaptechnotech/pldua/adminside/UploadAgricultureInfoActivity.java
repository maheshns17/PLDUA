...
public class UploadAgricultureInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_agriculture_info);
        context = UploadAgricultureInfoActivity.this;
    ...
    private void Register() {
        ...
        P.hideSoftKeyboard(UploadAgricultureInfoActivity.this);
