        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    Toast.makeText(DiseaseIdentificationActivity.this, "Image Saved!", Toast.LENGTH_SHORT).show();
                    imageview.setImageBitmap(bitmap);

                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(DiseaseIdentificationActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
